...
public class ExampleOfTableViewController implements Initializable{
    ...
    //These instance variables are used to create new Person objests
     ...
     * the detailed view
     */
    public void changeScreenToDetailedPersonView(ActionEvent event) throws IOException{
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        //This will allow the table to selevt multiple rows at once
    ...
    public ObservableList<Person> getPeople(){
        ...
        people.add(new Person("Frank","Sinatra",LocalDate.of(1915, Month.DECEMBER, 12), new Image("file:C:\\Users\\Sean\\Documents\\NetBeansProjects\\SceneBuilderPractice\\src\\main\\java\\com\\mycompany\\scenebuilderpractice\\images\\black_ship.jpg")));
        people.add(new Person("Rebecca","Fergusson",LocalDate.of(1986, Month.JULY, 21), new Image("file:C:\\Users\\Sean\\Documents\\NetBeansProjects\\SceneBuilderPractice\\src\\main\\java\\com\\mycompany\\scenebuilderpractice\\images\\smallVessel.jpg")));
